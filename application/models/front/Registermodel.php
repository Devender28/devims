	...
	function __construct()
    {
      ...
      if(isset($_POST['register'])){
        ...
        extract($_POST);
				...
				$this->form_validation->set_rules('email', 'Email Address', 'required|trim|valid_email|is_unique[registrations.email]');
				...
				if($id > 0)
				{
					...
					<p>This is email verification mail from Codeigniter Login Register system. For complete registration process and login into system. First you want to verify you email by click this <a href='".base_url()."email/verify/".$verification_key."'>link</a>.</p>
				...
				// 	{
				// // 		echo '<div class="alert alert-success">Check in your email for email verification mail!</div>';
				// 	$res['msg'] = '<div class="alert alert-success">Check in your email for email verification mail!</div>';
				// 	$res['status'] = 'success';
				// 	echo json_encode($res);

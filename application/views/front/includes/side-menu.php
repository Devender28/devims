                    ...
                    <div class="sidebar_content_details style3">
                        ...
                        <div class="sidebar_listing_list style2 mobile_sytle_sidebar mb0">
                            <div class="terms_condition_widget">
                                <h4 class="title">Categories Property<a class="filter_closed_btn float-right" href="#">
                                        <!-- <small>Hide Filter</small> --> <span class="flaticon-close"></span></a>
                                </h4>
                                                                ...
                                                                <li>
                                                                    <div class="custom-control custom-checkbox">
                                                                        ...
                                                                        <label class="custom-control-label"
                                                                            for="customCheck1">Air Conditioning</label>
                                                                    </div>
                                                                </li>
                                                                <li>
                                                                    <div class="custom-control custom-checkbox">
                                                                ...
                                                                <li>
                                                                    <div class="custom-control custom-checkbox">
                                                                        <input type="checkbox"
                                                                            ...
                                                                            id="customCheck8">
                                                                        <label class="custom-control-label"
                                                                            for="customCheck8">Outdoor Shower</label>
                                                                    </div>
                                                                </li>
                                                                <li>
                                                                    <div class="custom-control custom-checkbox">
                                                                        <input type="checkbox"
                                                                            ...
                                                                            id="customCheck15">
                                                                        <label class="custom-control-label"
                                                                            for="customCheck15">Window Coverings</label>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                                        </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="breadcrumb_content style2 mt30-767 mb30-767">
                    ...
                    <h2 class="breadcrumb_title">Search Result</h2>
                </div>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="sidebar_listing_list">
                        <div class="sidebar_advanced_search_widget">
                            <ul class="sasw_list mb0">
                                ...
                                <li class="area list-inline-item">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="exampleInputName2"
                                            placeholder="Area">
                                    </div>

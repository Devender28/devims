                ...
                <div class="row">
                    <div class="col-lg-12 mb10">
                        <div class="breadcrumb_content style2">
                            ...
                            <h2 class="breadcrumb_title">Hi, <?php echo $user->name;?>!</h2>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-6 col-xl-3">
                        <div class="ff_one">
                            ...
                            <div class="detais">
                                <div class="timer"><?php echo get_count('order_details','user_id',$this->session->userdata('id'));?></div>
                                <p>My Properties</p>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript" src="<?php echo base_url(FRONT_ASSETS);?>js/chart.min.js"></script>
<script type="text/javascript" src="<?php echo base_url(FRONT_ASSETS);?>js/chart-custome.js"></script>
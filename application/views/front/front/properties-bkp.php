                    ...
                    <tbody>
                        <tr>
                                ...
                                <div class="feat_property list favorite_page style2">
                                    ...
                                    <div class="details">
                                        <div class="tc_content">
                                            <a href="product-view.php"><h4>Renovated Apartment</h4></a>
                                            <p><span class="flaticon-placeholder"></span> Banjara Hills, Hyderabad</p>
                                            <a class="fp_price text-thm" href="javascript: void()">₹ 13,00,000</a>
                                        </div>
                                    </div>
                                </div>
                            </th>
                            ...
                            <td>
                                <ul class="view_edit_delete_list mb0">
                                    <li class="list-inline-item" data-toggle="tooltip" data-placement="top"
                                        title="View"><a href="product-view.php"><span
                            ...
                            <th scope="row">
                                <div class="feat_property list favorite_page style2">
                                    ...
                                    <div class="details">
                                        <div class="tc_content">
                                            <a href="product-view.php"><h4>Renovated Apartment</h4></a>
                                            <p><span class="flaticon-placeholder"></span> Jubilee Hills, Hyderabad</p>
                                            <a class="fp_price text-thm" href="javascript: void()">₹ 30,00,000</a>
                                        </div>
                                    </div>
                                </div>
                            </th>
                        ...
                        <tr>
                            <th class="active" scope="row">
                                <div class="feat_property list favorite_page style2">
                                    <div class="thumb">
                                        <img class="img-whp" src="<?php echo base_url(FRONT_ASSETS);?>images/property/fp3.jpg" alt="fp3.jpg">
                                    </div>
                                    <div class="details">
                                        <div class="tc_content">
                                            <a href="product-view.php"><h4>Renovated Apartment</h4></a>
                                            <p><span class="flaticon-placeholder"></span> Uppal, Hyderabad</p>
                                            <a class="fp_price text-thm" href="javascript: void()">₹ 23,00,000</a>
                                        </div>
                                    </div>
                                </div>
                            </th>
                        ...
                        <tr>
                            <th scope="row">
                                <div class="feat_property list favorite_page style2">
                                    <div class="thumb">
                                        <img class="img-whp" src="<?php echo base_url(FRONT_ASSETS);?>images/property/fp4.jpg" alt="fp4.jpg">
                                        <div class="thmb_cntnt">
                                            <ul class="tag mb0">
                                                <li class="list-inline-item dn"></li>
                                                <li class="list-inline-item"><a href="javascript: void()">For Sale</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="details">
                                        <div class="tc_content">
                                            <a href="product-view.php"><h4>Renovated Apartment</h4></a>
                                            <p><span class="flaticon-placeholder"></span> Secunderabad, Hyderabad</p>
                                            <a class="fp_price text-thm" href="javascript: void()">₹ 25,00,000</a>
                                        </div>
                                    </div>
                                </div>
                            </th>

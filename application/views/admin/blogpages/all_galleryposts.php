          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="float-right page-breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item "><a href="<?php echo base_url('admin/blog/addpostgallery');?>">Add Gallery Post</a></li>
                </ol>
              </div>
              <h5 class="page-title">Blog Gallery Posts Details</h5>
            </div>
          </div>
          <!-- end row -->
          <div class="row">
									...
									<tbody>
										...
										<tr class="gradeX">
											...
											<td>
												 ...
												 <a href="<?php echo base_url('admin/blog/editpostgal').'/'.$post->id;?>" title="Edite Details"><span class="btn btn-warning waves-effect waves-light"><i class="ion-edit"></i></span></a> 

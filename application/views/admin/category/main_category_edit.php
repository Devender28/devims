          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="float-right page-breadcrumb">
                ...
                <ol class="breadcrumb">
                   <li class="breadcrumb-item "><a href="<?php echo base_url();?>admin/category/details">View Category Details</a></li>
                    ...
                    <form action="<?php echo base_url();?>admin/<?php echo $this->uri->segment(2);?>/<?php echo $this->uri->segment(3);?>/<?php echo $this->uri->segment(4);?>" method="post" enctype="multipart/form-data">
                        ...
                        <div>
                          <select class="js-select2 form-control" name="design_cat" style="width: 100%;" data-placeholder="Choose one.." required>
                           ...
                           <option value="residential" <?php if($maincategory->design_cat == 'residential') echo "selected";?>>Residential</option>
                           <option value="commercial" <?php if($maincategory->design_cat == 'commercial') echo "selected";?>>Commercial</option> 
                          </select>
                        </div>
                      </div>

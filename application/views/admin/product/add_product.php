                ...
                <div class="card-body">
                  <div class="col-lg-8 col-md-offset-4">
					...
					<div class="form-group">
                        ...
                        <div>
                          <input type="radio"  name="free_paid" value="Free"  required>
<label for="Free">Free</label> &nbsp;&nbsp;
<input type="radio" name="free_paid" value="Paid" checked>
...
?>
					  ...
					  <div class="form-group">
                        <label>Type</label>
                        <div>
                          <input type="radio" checked name="offer_premium" value="Offer">
...
<label for="Premium">Premium</label><br>
			...
			<div class="form-group">
					 ...
					 <div class="form-group">
                        <label>Parking</label>
                        <div>
                          <input type="radio" checked name="parking" value="Yes">
...
<label for="NO">NO</label><br>
					  ...
					  <div class="form-group">
                        ...
                        <div>
                          <input type="radio" checked name="compound_wall" value="Yes">
<label for="Yes">Yes</label> &nbsp;&nbsp;
...
<div class="form-group">
                        <label>Kitchen</label>
                        <div>
                          <input type="radio" checked name="kitchen" value="Yes">
<label for="Yes">Yes</label> &nbsp;&nbsp;
...
<label for="Yes">Yes</label> &nbsp;&nbsp;
<input type="radio" name="additional_rooms" checked value="NO">
<label for="NO">NO</label><br>
                        </div>
                      </div>	
 ...
 -->                     
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        <label>Multiple Images (960px x 400px)</label>
                        <div>
					  ...
					  <div class="form-group">
                        <label>First Floor Plan Image (620px x 465px)</label>
                        <div>
                      	...
                      	<div class="form-group">
                        <label>First Floor Description</label>
                        <div>
                       <textarea  class="summernote" name="first_floor_description"></textarea>
                        </div>
                      </div>
					  ...
					  <div class="form-group">
					   ...
					   <div class="form-group">
                        <label>Second Floor Plan Image (620px x 465px)</label>
                        <div>
					  	...
					  	<div class="form-group">
                        <label>Second Floor Description</label>
                        <div>
                       <textarea  class="summernote" name="second_floor_description"></textarea>
                        </div>
                      </div>
                    ...
                    <div class="form-group">
					  ...
					  <div class="form-group">
                        <label>Featured Image (360px x 230px)</label>
                        <div>

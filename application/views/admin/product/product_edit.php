            ...
            <div class="col-lg-12">
              <div class="card m-b-30">
				...
				<div class="form-group">
                        ...
                        <div>
                          <input type="radio"  name="free_paid" value="Free" <?php if($product->free_paid == 'Free') echo "checked" ;?>  required>
<label for="Free">Free</label> &nbsp;&nbsp;
<input type="radio" name="free_paid" value="Paid" <?php if($product->free_paid == 'Paid') echo "checked" ;?>>
...
<label for="NO">NO</label><br>
					  ...
					  <div class="form-group">
                        <label>First Foor Plan Image (620px x 465px)</label>
                        <div>
                      ...
                      <div class="form-group">
                        ...
                        <div>
                       <textarea  class="summernote" name="first_floor_description"><?php echo $product->first_floor_description;?></textarea>
                        </div>
                      </div>
					  ...
					  <div class="form-group">
					   ...
					   <div class="form-group">
                        <label>Second Foor Plan Image (620px x 465px)</label>
                        <div>
                        ...
                        <div>
                       <textarea  class="summernote" name="second_floor_description"><?php echo $product->second_floor_description;?></textarea>
                        </div>
                      </div>

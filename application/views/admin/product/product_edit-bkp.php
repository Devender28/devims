...
<div class="form-group">
                        ...
                        <div>
                          <select class="js-select2 form-control" id="select-farmer-name-2" name="style" style="width: 100%;" data-placeholder="Choose one.."  onchange="showCategory(this.value)"  required>
...
<label for="Premium">Premium</label><br>
                      ...
                      <div class="form-group">
                        ...
                        <div>
                          <select class="js-select2 form-control" id="select-farmer-name-2" name="cat_id" style="width: 100%;" data-placeholder="Choose one.."  onchange="showCategory(this.value)"  required>
...
?>
			...
			<div class="form-group">
					  ...
					  <div class="form-group">
                        <label>Faceing </label>
                        <div>
                          <input type="text" class="form-control" name="faceing" value=""  >
                        </div>
                      </div>
...
<label for="NO">NO</label><br>
					  ...
					  <div class="form-group">
                        ...
                        <div>
                          <input type="radio"  name="build_up_area" value="Yes" <?php if($product->build_up_area == 'Yes') echo "checked" ;?>>
<label for="Yes">Yes</label> &nbsp;&nbsp;
<input type="radio" name="build_up_area" value="NO" <?php if($product->build_up_area == 'NO') echo "checked" ;?>>
<label for="NO">NO</label><br>
                        </div>
                      </div>

    ...
    $(window).on('scroll', function () {
        ...
        if ($('.stricky').length) {
            ...
            if ($(window).scrollTop() > headerScrollPos) {
                $('.stricky div.top-bar').css('display', 'none');
                $('.stricky a.navbar_brand').css('margin-top', '10px');
                stricky.removeClass('slideIn animated');
                stricky.addClass('stricky-fixed slideInDown animated');
            } else if ($(this).scrollTop() <= headerScrollPos) {
                $('.stricky div.top-bar').css('display', 'block');
                $('.stricky a.navbar_brand').css('margin-top', '-15px');
...
// Added by Venkat - for Star Rating
